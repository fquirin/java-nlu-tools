...
*/
public class CharSequence2TokenSequenceCustom extends Pipe implements Serializable {
	CharSequenceLexer lexer;
	
	public CharSequence2TokenSequenceCustom(CharSequenceLexer lexer){
		this.lexer = lexer;
	}

	public CharSequence2TokenSequenceCustom(String regex){
		this.lexer = new CharSequenceLexer (regex);
	}

	public CharSequence2TokenSequenceCustom(Pattern regex){
		this.lexer = new CharSequenceLexer(regex);
	}

	public CharSequence2TokenSequenceCustom(){
	...
	public Instance pipe(Instance carrier){
		...
		//System.out.println(ts.toString()); 		//DEBUG
		carrier.setData(ts);
		return carrier;
	}
		...
		try{
			for (int i = 0; i < args.length; i++){
				...
				SerialPipes p = new SerialPipes(new Pipe[] {
					...
					new CharSequence2TokenSequenceCustom(new CharSequenceLexer())});
